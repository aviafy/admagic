...
class ModerationAgent {
    constructor(openaiKey, geminiKey, preferredProvider = constants_1.AIProvider.OPENAI) {
        ...
        this.gemini = null;
        this.logger.log(`Constructor called with preferredProvider: ${preferredProvider}`);
        ...
        this.logger.log(`Initializing services with preferredProvider: ${preferredProvider}`);
